...
<body>
    ...
    <div class="col" style="padding-left: 50px;padding-right: 50px;margin-top: 30px;">
        <div class="row d-xxl-flex justify-content-xxl-center" style="margin-bottom: 10px;">
            <div class="col d-xl-flex d-xxl-flex m-auto" style="max-width: 75%;">
                <div class="card">
                    <div class="card-body"><img alt="" style="width: 100%;height: auto;border-radius: 10px;max-height: 300px;" src="" onerror="this.onerror=null;this.src='/static/img/1280x720_Placeholder.png';">
